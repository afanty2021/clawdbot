...
on run
	log "测试 cliclick + 递增Y坐标"
	log "============================================================"

	do shell script "printf '' > /Users/berton/Github/OpenClaw/ima-ytest.txt"
	...
	repeat with i from 1 to 5
		...
		if articleUrl starts with "http" then
			if articleUrl is not equal to lastUrl then
				...
				do shell script "echo '" & i & "|" & currentY & "|NEW|" & text 1 thru 60 of articleUrl & "' >> /Users/berton/Github/OpenClaw/ima-ytest.txt"
			else
				log "   DUP: same as previous"
				do shell script "echo '" & i & "|" & currentY & "|DUP' >> /Users/berton/Github/OpenClaw/ima-ytest.txt"
			end if
		else
			log "   FAIL: no URL"
			do shell script "echo '" & i & "|" & currentY & "|FAIL' >> /Users/berton/Github/OpenClaw/ima-ytest.txt"
		end if
